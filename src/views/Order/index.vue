  ...
  <div class="dashboard-container" id="order-app" v-loading="loading">
    <div class="container">
      ...
      <el-table :data="tableData" stripe class="tableBox">
        ...
        <el-table-column prop="btn" width="180px" label="操作">
          <template slot-scope="{ row }">
            <el-button type="primary" size="mini" @click="goDetail(row)" class="blueBug">
              查看
            </el-button>
            <el-divider
              v-if="row.status === 2"
    ...
    >
      <div class="info-box">
        ...
        <div class="item-box">
          ...
          <span class="des">{{ moment(diaForm.orderTime).format("YYYY-MM-DD HH:mm:ss") }}</span>
        </div>
      </div>
    </el-dialog>
  </div>
        ...
        .then((res) => {
          if (String(res.code) === "200") {
            ...
            this.tableData = res.data.records || [];
              this.$store.state.user.orderlist=this.tableData;
